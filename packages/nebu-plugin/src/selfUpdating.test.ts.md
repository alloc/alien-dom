...
> Snapshot 1
    ...
    `import { registerCallback as __registerCallback } from 'alien-dom/helpers'␊
...
> Snapshot 3
    ...
    `import { registerCallback as __registerCallback } from 'alien-dom/helpers'␊
    function createInput() { const inner = () => {}; return function Input() { const outer = __registerCallback("0#0", () => inner(), [inner]) } }`

## auto-memoized function declared before variable referenced by it

> Snapshot 1

    `import { registerCallback as __registerCallback, registerNestedTag as __nestedTag } from 'alien-dom/helpers'␊
...
> Snapshot 1
    ...
    `import { registerMemo as __registerMemo } from 'alien-dom/helpers'␊
